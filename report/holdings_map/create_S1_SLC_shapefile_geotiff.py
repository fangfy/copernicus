...
#                          - the zip list is created by running 'S1_file_list.bash'
#
# Usage: create_S1_shapefile_geotiff.py [zip_list]
...
yr_mth = list1[0]
shape_file = "%s_S1_SLC.shp" % yr_mth
proj_file = "%s_S1_SLC" % yr_mth
